 ...
 */
public class LinearLayoutManager extends android.support.v7.widget.RecyclerView.LayoutManager implements
        ItemTouchHelper.ViewDropHandler, android.support.v7.widget.RecyclerView.SmoothScroller.ScrollVectorProvider {
     ...
     *                                 indices.
     */
    void onAnchorReady(android.support.v7.widget.RecyclerView.Recycler recycler, android.support.v7.widget.RecyclerView.State state,
    ...
    private void layoutForPredictiveAnimations(android.support.v7.widget.RecyclerView.Recycler recycler,
                                               android.support.v7.widget.RecyclerView.State state, int startOffset,
                                               int endOffset) {
    ...
    private void updateAnchorInfoForLayout(android.support.v7.widget.RecyclerView.Recycler recycler, android.support.v7.widget.RecyclerView.State state,
     ...
     */
    private boolean updateAnchorFromChildren(android.support.v7.widget.RecyclerView.Recycler recycler,
                                             android.support.v7.widget.RecyclerView.State state, AnchorInfo anchorInfo) {
        if (getChildCount() == 0) {
            return false;
        }
    ...
    void collectPrefetchPositionsForLayoutState(android.support.v7.widget.RecyclerView.State state, LayoutState layoutState,
     ...
     */
    private View findReferenceChildClosestToEnd(android.support.v7.widget.RecyclerView.Recycler recycler,
                                                android.support.v7.widget.RecyclerView.State state) {
     ...
     * @return A View that can be used an an anchor View.
     */
    private View findReferenceChildClosestToStart(android.support.v7.widget.RecyclerView.Recycler recycler,
                                                  android.support.v7.widget.RecyclerView.State state) {
        return mShouldReverseLayout ? findLastReferenceChild(recycler, state) :
                findFirstReferenceChild(recycler, state);
    }

    private View findFirstReferenceChild(android.support.v7.widget.RecyclerView.Recycler recycler, android.support.v7.widget.RecyclerView.State state) {
        return findReferenceChild(recycler, state, 0, getChildCount(), state.getItemCount());
    }

    private View findLastReferenceChild(android.support.v7.widget.RecyclerView.Recycler recycler, android.support.v7.widget.RecyclerView.State state) {
        return findReferenceChild(recycler, state, getChildCount() - 1, -1, state.getItemCount());
    }

    // overridden by GridLayoutManager
    View findReferenceChild(android.support.v7.widget.RecyclerView.Recycler recycler, android.support.v7.widget.RecyclerView.State state,
    ...
    private View findPartiallyOrCompletelyInvisibleChildClosestToEnd(android.support.v7.widget.RecyclerView.Recycler recycler,
                                                                     android.support.v7.widget.RecyclerView.State state) {
    ...
    private View findFirstPartiallyOrCompletelyInvisibleChild(android.support.v7.widget.RecyclerView.Recycler recycler,
                                                              android.support.v7.widget.RecyclerView.State state) {
        return findOnePartiallyOrCompletelyInvisibleChild(0, getChildCount());
    }

    private View findLastPartiallyOrCompletelyInvisibleChild(android.support.v7.widget.RecyclerView.Recycler recycler,
                                                             android.support.v7.widget.RecyclerView.State state) {
    ...
    static class LayoutState {
        ...
        /**
         * The most recent {@link #scrollBy(int, android.support.v7.widget.RecyclerView.Recycler, android.support.v7.widget.RecyclerView.State)}
         * amount.
         */
