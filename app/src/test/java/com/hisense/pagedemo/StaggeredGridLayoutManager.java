 ...
 */
public class StaggeredGridLayoutManager extends android.support.v7.widget.RecyclerView.LayoutManager implements
    ...
    /**
     * When scroll state is changed to {@link android.support.v7.widget.RecyclerView#SCROLL_STATE_IDLE}, StaggeredGrid will
     ...
     * When set to true, If {@link android.support.v7.widget.RecyclerView} is LTR, than it will layout from RTL, if
     * {@link android.support.v7.widget.RecyclerView}} is RTL, it will layout from LTR.
     *
    ...
    private void onLayoutChildren(android.support.v7.widget.RecyclerView.Recycler recycler, android.support.v7.widget.RecyclerView.State state,
    ...
    void updateAnchorInfoForLayout(android.support.v7.widget.RecyclerView.State state, AnchorInfo anchorInfo) {
    ...
    boolean updateAnchorFromPendingData(android.support.v7.widget.RecyclerView.State state, AnchorInfo anchorInfo) {
     ...
     * any items, {@link android.support.v7.widget.RecyclerView#NO_POSITION} is returned for that span.
     ...
     * not have any items, {@link android.support.v7.widget.RecyclerView#NO_POSITION} is returned for that span.
     ...
     * have any items, {@link android.support.v7.widget.RecyclerView#NO_POSITION} is returned for that span.
     * @see #findFirstCompletelyVisibleItemPositions(int[])
     * @see #findLastVisibleItemPositions(int[])
     */
    ...
    @Override
    public void onInitializeAccessibilityNodeInfoForItem(android.support.v7.widget.RecyclerView.Recycler recycler,
                                                         android.support.v7.widget.RecyclerView.State state, View host, AccessibilityNodeInfoCompat info) {
    ...
    @Override
    public int getRowCountForAccessibility(android.support.v7.widget.RecyclerView.Recycler recycler,
    ...
    @Override
    public int getColumnCountForAccessibility(android.support.v7.widget.RecyclerView.Recycler recycler,
                                              android.support.v7.widget.RecyclerView.State state) {
        if (mOrientation == VERTICAL) {
            return mSpanCount;
        }
    ...
    private void fixEndGap(android.support.v7.widget.RecyclerView.Recycler recycler, android.support.v7.widget.RecyclerView.State state,
    ...
    private void fixStartGap(android.support.v7.widget.RecyclerView.Recycler recycler, android.support.v7.widget.RecyclerView.State state,
                             boolean canOffsetChildren) {
    ...
    private int fill(android.support.v7.widget.RecyclerView.Recycler recycler, LayoutState layoutState,
                     android.support.v7.widget.RecyclerView.State state) {
    ...
    private void recycle(android.support.v7.widget.RecyclerView.Recycler recycler, LayoutState layoutState) {
    ...
    /** @hide */
    @Override
    public void collectAdjacentPrefetchPositions(int dx, int dy, android.support.v7.widget.RecyclerView.State state,
    ...
    @Override
    public android.support.v7.widget.RecyclerView.LayoutParams generateLayoutParams(ViewGroup.LayoutParams lp) {
    ...
    @Nullable
    @Override
    public View onFocusSearchFailed(View focused, int direction, android.support.v7.widget.RecyclerView.Recycler recycler,
            android.support.v7.widget.RecyclerView.State state) {
        if (getChildCount() == 0) {
            return null;
        }
        ...
        final int referenceChildPosition;
        if (layoutDir == LAYOUT_END) { // layout towards end布局走向终点
            referenceChildPosition = getLastChildPosition();
        } else {
            referenceChildPosition = getFirstChildPosition();
        }
        ...
        // traverse all spans翻译：/或者无法找到所需的跨度或上一个视图是全跨度。 遍历所有跨度
        ...
        //翻译：无法从任何现有跨度中找到任何可聚焦的视图。 现在开始搜索，找到最佳的不可聚焦的候选者
        // ，然后在屏幕上显示。 搜索以相同的方式完成：首先，检查所需范围内的视图，如果没有找到候选项，
        // 则遍历所有剩余跨度中的视图
    ...
    class Span {
         ...
         * {@link #onFocusSearchFailed(View, int, android.support.v7.widget.RecyclerView.Recycler, android.support.v7.widget.RecyclerView.State)} for
         ...
         * {@link android.support.v7.widget.RecyclerView#NO_POSITION} if no such view is found.
         */
