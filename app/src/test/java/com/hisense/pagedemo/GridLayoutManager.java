...
/**
 * A {@link android.support.v7.widget.RecyclerView.LayoutManager} implementations that lays out items in a grid.
 * <p>
...
public class GridLayoutManager extends LinearLayoutManager {
    ...
    private void ensureAnchorIsInCorrectSpan(android.support.v7.widget.RecyclerView.Recycler recycler,
                                             android.support.v7.widget.RecyclerView.State state, AnchorInfo anchorInfo, int itemDirection) {
    ...
    private int getSpanGroupIndex(android.support.v7.widget.RecyclerView.Recycler recycler, android.support.v7.widget.RecyclerView.State state,
                                  int viewPosition) {
        if (!state.isPreLayout()) {
    ...
    private void assignSpans(android.support.v7.widget.RecyclerView.Recycler recycler, android.support.v7.widget.RecyclerView.State state, int count,
