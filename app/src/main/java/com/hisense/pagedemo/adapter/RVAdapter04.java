 ...
 * ===================================================
 */
public class RVAdapter04 extends BaseMultiItemQuickAdapter<RVBean04, BaseViewHolder> {


    private boolean isShowPosition = true;

    public RVAdapter04(List<RVBean04> data) {
        super(data);
        addItemType(RVBean04.TYPE_ONE, R.layout.rv_header_04);
