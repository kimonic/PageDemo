...
public class FocusKeepRecyclerView extends RecyclerView {
    ...
    public View focusSearch(View focused, int direction) {
        ...
        if (view != null) {
            //该方法返回焦点view所在的父view,如果是在recyclerview之外，就会是null.所以根据是否是null,
            // 来判断是否是移出了recyclerview
    ...
    public void addFocusables(ArrayList<View> views, int direction, int focusableMode) {
        View view = null;
        if (this.hasFocus() || mCurrentFocusPosition < 0
                || (view = getLayoutManager().findViewByPosition(mCurrentFocusPosition)) == null) {
